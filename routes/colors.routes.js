...
router.patch("/:colorId", validateSchema(updateColorSchema), verifyToken, verifyRole(constants.db.adminOnly), checkActiveUser, colorsController.updateColor);
router.delete("/:colorId", verifyToken, verifyRole(constants.db.adminOnly), checkActiveUser, colorsController.deleteColor);
router.get("/{:colorId}", verifyToken, verifyRole(constants.db.adminOnly), checkActiveUser, colorsController.getColors);
